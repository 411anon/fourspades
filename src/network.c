...
#ifndef OPENGL_ES
#ifdef OS_WINDOWS
	char* os = "fourspades (Windows) " GIT_COMMIT_HASH;
#endif
#ifdef OS_LINUX
	char* os = "fourspades (Linux) " GIT_COMMIT_HASH;
#endif
#ifdef OS_APPLE
	char* os = "fourspades (Apple) " GIT_COMMIT_HASH;
#endif
#ifdef OS_HAIKU
	char* os = "fourspades (Haiku) " GIT_COMMIT_HASH;
#endif
#else
#ifdef USE_TOUCH
	char* os = "fourspades (Android) " GIT_COMMIT_HASH;
#else
	char* os = "fourspades (Embedded) " GIT_COMMIT_HASH;
#endif
#endif
